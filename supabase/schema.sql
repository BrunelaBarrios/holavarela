...
-- Creador privado de curriculums. Solo se accede desde rutas del servidor.
...
create index if not exists curriculums_generados_busqueda_idx on public.curriculums_generados (creado_at desc, estado_pago);
...
-- Origen de los emprendimientos locales y regionales.
