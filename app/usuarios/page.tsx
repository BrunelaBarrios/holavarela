      ...
      <div className="mx-auto max-w-7xl space-y-6">
        ...
        <div className="grid gap-6 xl:grid-cols-[1.1fr_0.9fr]">
          <section className="space-y-6">
            ...
            <EventsSection title="Eventos en borrador" emptyTitle="No tienes eventos en borrador" emptyDescription="Los borradores quedan listos para revisar o completar antes de publicarse." events={draftEvents} allowDraftResume />
          </section>
