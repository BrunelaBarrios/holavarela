...
export default function UsuariosHomePage() {
  ...
  const handleCreateProfile = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    if (entityType === "institucion" && !institucion.nombre.trim()) {
      setError("Completa el nombre de la institución.")
      return
    }
  ...
  return (
    <main className="min-h-screen overflow-x-hidden bg-[linear-gradient(180deg,#f8fbff_0%,#eef7f2_45%,#ffffff_100%)] px-3 py-6 text-slate-900 sm:px-6 sm:py-8 lg:px-8">
      <AdminConfirmModal
        ...
        description="Vas a borrar este evento desde tu panel. Esta acción no se puede deshacer."
      ...
      cancelledEvents.length === 0 ? (
        ...
        <div className="mt-6 space-y-8">
          ...
          <EventGroup
            ...
            emptyDescription="Los eventos cancelados quedan guardados para que puedas revisarlos o reactivarlos más adelante."
