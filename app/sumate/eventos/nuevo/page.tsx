              ...
              <div className="grid lg:grid-cols-[1.05fr_1.15fr]">
                <div className="bg-[radial-gradient(circle_at_top_left,#d7f0db_0%,#e9f7ef_35%,#edf5ff_100%)] px-6 py-8 sm:px-8 sm:py-10">
                      ...
                      <div className="mt-4 space-y-3">
                        <div className="flex gap-3">
                          ...
                          <div className="text-sm leading-6 text-slate-600">
                            Usa un titulo corto y claro para que se entienda de un vistazo.
                          </div>
                        </div>
                        <div className="flex gap-3">
                          <div className="mt-1 h-2.5 w-2.5 rounded-full bg-emerald-500" />
                          <div className="text-sm leading-6 text-slate-600">
                            Agrega fecha, ubicacion y una descripcion concreta.
                          </div>
                        </div>
                        <div className="flex gap-3">
                          <div className="mt-1 h-2.5 w-2.5 rounded-full bg-amber-500" />
                          <div className="text-sm leading-6 text-slate-600">
                            Si tienes imagen, mejor: levanta mucho la publicacion.
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="mt-8 flex flex-wrap gap-3">
                    <button
                      type="button"
                      onClick={() => router.push("/sumate/panel")}
                    ...
                    <LinkButton href="/" label="Ver sitio publico" />
                  </div>
                </div>
