...
export const metadata: Metadata = { title: "Hecho en Varela y la región | Hola Varela!", description: "Productos creados por artesanos y emprendedores de José Pedro Varela y la región.", robots: { index: true, follow: true } }
